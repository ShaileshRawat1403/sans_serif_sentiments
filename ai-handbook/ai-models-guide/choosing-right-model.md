...
* Best for processing long documents
* Best for summarizing audio calls

Think of models like teammates:

* Some brainstorm better
* Some summarize better
...
| ---------------- | ---------------------- | ----------------------------- | ----------------------------- |
| Content Writer   | Structure + Creativity | GPT-4o, Claude 3 Opus         | Great formatting, subtle tone |
| Research Analyst | Reading + Summarizing  | Claude 3 Opus, Gemini 1.5 Pro | Handles long, dense inputs    |
| Product Manager  | Synthesis + Planning   | Gemini, GPT-4o                | Multimodal + system thinking  |
| Developer        | Code + Explanations    | GPT-4o, StarCoder, Claude     | Strong code insight           |
...
| --------------- | ------------------------ | ----------------------------- |
| Plain Text      | Claude, GPT-4o           | Clean, coherent outputs       |
| Image           | GPT-4o, Gemini           | Image + reasoning             |
| Audio           | Gemini, Whisper + GPT    | Transcription + QA layering   |
...
| --------------------- | -------------------- | ------------------------------- |
| Minimal Hallucination | Claude Opus, Mistral | Safer defaults, aligned style   |
| Creative Drafting     | GPT-4o, Gemini       | Bold suggestions, less filtered |
...
| Need               | Use                    | Model Tip             |
| ------------------ | ---------------------- | --------------------- |
| 🔁 Fast Replies    | Chatbots, Email Drafts | Claude Haiku, Mistral |
| 📘 Depth & Insight | Reports, Essays        | GPT-4o, Claude Opus   |
| 🔍 Retrieval       | FAQ, Search Tools      | Gemini, GPT w/ Browse |
| 🎭 Brand Voice     | Tone-Consistent Output | Fine-tuned GPTs       |
...
* [ ] Will the output be **shared externally**?
