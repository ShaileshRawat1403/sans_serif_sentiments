...
- [📘 Repo Overview: Full Section Map](#-repo-overview-full-section-map)
...
### Bonus:
- Want a weekly check-in? Jump to [Weekly Reflection Journal](#weekly-dev-reflection)
...
➡️ _[Flavor & Function – Writing as a system](https://github.com/ShaileshRawat1403/sans_serif_sentiments/blob/main/fnf/flavor-and-function.md)_  
➡️ _[Prompted But Not Prepared – The AI Gap Handbook](https://github.com/ShaileshRawat1403/sans_serif_sentiments/blob/main/ai-handbook%2Fprompted-but-not-prepared%2FREADME.md)_  
➡️ _[This Might Change Everything – Change Comms Toolkit](https://github.com/ShaileshRawat1403/sans_serif_sentiments/blob/main/change-communications%2Fthis-might-change-everything%2FREADME.md)_
...
👉 [Go to: Thinking Before Code →](#thinking-before-code)

Or reflect before you write:  
👉 [Jump to: Weekly Dev Journal →](#weekly-dev-reflection)
...
Next: [Ladders vs Loops →](#ladders-vs-loops)
...
Next: [AI as Thought Partner →](#ai-as-thought-partner)
...
Next: [Cognitive Design Laws →](#cognitive-design-laws)
...
Next Chapter: [Doing During Code →](#doing-during-code)
...
Next: [Debug Like a Theorist →](#debug-like-a-theorist)
...
Next: [Commit With Clarity →](#commit-with-clarity)
...
Next: [AI Copilot Templates →](#ai-copilot-templates)
...
Up Next: [Communicating Beyond Code →](#communicating-beyond-code)
...
Next: [Technical Decision-Making →](#technical-decision-making)
...
Next: [Handoff Systems →](#handoff-systems)
...
Next: [Writing for Non-Devs →](#writing-for-non-devs)
...
Up Next: [Existing Outside the Terminal →](#existing-outside-terminal)
...
Next: [Dev Growth Compass →](#dev-growth-compass)
...
Next: [Developer Routines →](#developer-routines)
...
Next: [AI Copilot Primer →](#ai-copilot-primer)
...
Next: [Pair Dev Guide →](#pair-dev-guide)
...
Next: [Clarity Checklist →](#clarity-checklist)
...
Next: [LICENSE & CONTRIBUTING →](#license--contributingmd)
...
Next: [Return to README →](#dev-life-systems)
