...
* The **philosophical and practical differences** between documents and presentations
* Why slide decks often oversimplify while docs preserve truth
...
| -------- | ------------------------- | ------------------------------------- |
| Purpose  | Convince, pitch, align    | Explain, support, clarify             |
| Format   | Bullets, slogans, visuals | Full sentences, structure, references |
| Depth    | High-level summary        | Detailed, actionable guidance         |
| Audience | Execs, stakeholders       | Users, builders, maintainers          |
...
* Hide nuance
* Flatten complexity
* Collapse when handed off to engineering or support teams

Docs, on the other hand:
...
| Use a Deck When...                         | Use a Doc When...                               |
| ------------------------------------------ | ----------------------------------------------- |
| You need buy-in or stakeholder interest    | You need clarity and execution                  |
| You’re pitching a new idea                 | You’re documenting the decision or architecture |
| Visual simplicity matters more than detail | Details, steps, risks, and clarity matter most  |
...
| -------- | --------------- | --------------- |
| Purpose  | Convince        | Clarify         |
| Timing   | Early           | Ongoing         |
| Audience | Decision-makers | Builders, users |
| Format   | Abstract        | Detailed        |
| Style    | Visual          | Textual         |
