...
> _“What even is technical writing?”_\
> &#xNAN;_“Do I need to code?”_\
> &#xNAN;_“Why do some companies pay so much for someone who writes ‘just docs’?”_

You're in the right place.

This isn’t just another content series.\
It’s a **beginner-friendly, honest, and practical roadmap** built by someone who didn’t come from tech — but _wrote their way in._
...
> _Writing isn’t dead — it’s just been distracted._\
...
| --------------------------------- | -------------------------------------------------------------------------- |
| `01-what-is-technical-writing.md` | Clear, honest definition of the role — with wit, analogies, and no fluff   |
| `02-types-of-docs.md`             | From setup guides to release notes — and what each one really does         |
| `03-roles-tools-skills.md`        | The actual day-to-day work, tools you'll touch, and thinking styles        |
| `04-writing-principles.md`        | Writing for clarity, not cleverness — and how to avoid user frustration    |
| `05-getting-started.md`           | How to start learning, practicing, and building proof of your skill        |
| `06-docs-vs-marketing.md`         | Why documentation is different from copywriting (and matters just as much) |
| `07-how-to-write-a-howto.md`      | A guided example: writing your first how-to doc                            |
| `08-building-your-portfolio.md`   | Tips for showcasing your docs, even if you’ve never worked in tech         |
| `09-careers-opportunities.md`     | Where this career can take you — and how to get noticed                    |
...
* The ones who believe _clarity is a form of care_
...
> _Documentation is not a deliverable. It’s damage control._\
